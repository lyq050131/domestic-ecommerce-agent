    ...
    "map_data": [
      {
        ...
        "price_promotion_info": {
          ...
          "final_promotion_price": "79.00",
          "final_promotion_path_list": [
            { "promotion_title": "商品券", "promotion_fee": "20.00" }
          ]
        },
        "income_info": {
          "commission_rate": "50",
          "commission_amount": "39.50"
        },
        "publish_info": {
          "click_url": "//item.taobao.com/item.htm?id=1234567890"
        }
      }
    ]
  }
...
> 升级版 `commission_rate` 直接为百分比，如 50 = 50%；预估佣金 = 99 × 50% = ¥49.5/单（未扣税，以联盟结算为准）。商品券金额取自到手价路径中 `promotion_title = "商品券"` 的 `promotion_fee` 累加。
